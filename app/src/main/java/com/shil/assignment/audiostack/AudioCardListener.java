...
import com.shil.assignment.HomeActivity;

/**
 * Created by snehasisshil on 21/04/18.
 */

public class AudioCardListener implements View.OnTouchListener {

    private static final String TAG = AudioCardListener.class.getSimpleName();
    ...
    private final AudioCardListener.FlingListener mFlingListener;
    private final Object dataObject;
    private final float halfWidth;
    private final int TOUCH_ABOVE = 0;
    private final int TOUCH_BELOW = 1;
    private final Object obj = new Object();
    public AudioCardListener.ActionDownInterface actionDownInterface;
    ...
    public AudioCardListener(View frame, Object itemAtPosition, AudioCardListener.FlingListener flingListener) {
        this(frame, itemAtPosition, 15f, flingListener);

    }

    public AudioCardListener(View frame, Object itemAtPosition, float rotation_degrees, AudioCardListener.FlingListener flingListener) {
        super();
